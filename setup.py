...
def create_sheet(credentials: Credentials, drive_id: str) -> str:
    ...
    update_body = {
        'requests': [
            ...
            _add_sheet_request(5, 'Feed'),
            _add_sheet_request(6, 'Bases', hidden=True),
            _add_sheet_request(7, 'OfferTypes', hidden=True),
            ...
            _paste_data_request(
                1, row=9, col=1, data="MC ID"),
            _paste_data_request(
                1, row=10, col=1, data="Filter MC Feed, TRUE"),
            _paste_data_request(
                1, row=11, col=1, data="DEBUG, FALSE"),
            ...
            _paste_data_request(6, row=0, col=None, data="Title, File, Products"),
            #_paste_data_request(5, row=1, col=0, data='Base Example, base_example.mp4'),
            _paste_data_request(6, row=1, col=0, data='Base Example; base_example.mp4; [{"start_time":3.1,"end_time":"7"}]', delimiter=";"),
            _paste_data_request(7, row=0, col=None,
                       data="Title, Base, Configs, Parent"),
            _paste_data_request(7, row=1, col=0,
            ...
            _paste_data_request(
                8, row=0, col=None, data="Date, AdsMetadata, VideoMetadata, Status, GeneratedVideo"),
            {
                'deleteSheet': {
                    'sheetId': 0,  # Sheet 1
                }
